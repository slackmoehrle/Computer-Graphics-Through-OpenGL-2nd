...
// 
// This program draws a cubic B-spline approximation of 9 control points.
...
// At the bottom  there are 13 white horizontal bars corresponding, from bottom to 
// top, to the first through thirteenth knots, each knot drawn green.
...
int main(int argc, char **argv) 
{
   ...
   glutCreateWindow("cubicSplineCurve1.cpp");
