...
// bSplines.cpp
//
// This program displays the non-zero parts of the graphs of B-spline functions of 
// orders 1, 2, 3 and 4. The joints are shown as points. At the bottom  there are 9 
// white horizontal bars corresponding, from bottom to top, to the first through 
// ninth knots, each knot drawn as a green point. The knot values can be changed.
// 
// Interaction:
