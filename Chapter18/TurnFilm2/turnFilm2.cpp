...
// turnFilm2.cpp
//
// This program draws a fixed red dashed polynomial Bezier curve with fixed control points
// on the z=1 plane. Intially the film lies along the z=1 plane as well but it can be
// turned towards the x=1 plane. Also drawn in dashed green is the polynomial Bezier curve
// approximating the projection of the control points on the film, as well as, optionally,
// a blue dashed rational Bezier curve that coincides with the projection of the red curve.
//
// Interaction:
...
int main(int argc, char **argv) 
{
   ...
   glutCreateWindow ("turnFilm2.cpp");
